PQOL =
{
	Config =
	{
		...
		PomIcons = true,
		Commendations = true,
		PracticeFishing = true,
		BossNumericHealth = true,
		RegularCallHint = true,
		PostBossWeaponSelect = true,
		CompleteAllBounties = true,
		Gameplay = true,
	}
}
...
if PQOL.Config.ChamberCounter then
...
if PQOL.Config.Commendations then
...
if PQOL.Config.PracticeFishing then
	--Practice fishing
...
if PQOL.Config.RegularCallHint then
...
if PQOL.Config.BossNumericHealth then
...
if PQOL.Config.CompleteAllBounties then
...
if PQOL.Config.PostBossWeaponSelect then
